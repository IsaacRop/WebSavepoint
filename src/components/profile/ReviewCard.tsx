...
export function ReviewCard({ review }: { review: Review }) {
  ...
  return (
    <article className="flex gap-4 py-4 border-b border-ink-10 last:border-0">
      {/* Placeholder cover — review game só tem id+title */}
      <div className="w-12 h-16 bg-ink-10 flex-shrink-0 flex items-end justify-center pb-1">
      ...
      <div className="flex flex-col gap-1 min-w-0 flex-1">
        <h3 className="font-sans text-base font-medium text-ink leading-snug">
          {review.game.title}
        </h3>
        ...
        {review.body && (
          <p className="font-sans text-sm text-ink-70 leading-relaxed line-clamp-2 mt-0.5">
